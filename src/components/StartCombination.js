...
export default function StartTimeAttack() {
  return (
      ...
      <div className=" flex justify-center items-center w-full h-[837px] bg-backgroundColor">
        ...
        <p className=" text-center text-xl font-medium whitespace-normal tracking-wide sm:tracking-wider md:tracking-widest leading-relaxed">Desafie sua mente no modo Combination: resolva contas duplas contra o relógio e ganhe tempo extra a cada acerto. Mantenha o ritmo e conquiste a vitória!</p>
